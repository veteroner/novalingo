/**
 * @deprecated Legacy conversation templates — use ConversationScenario registry instead.
 * Kept as fallback while registry coverage is being expanded.
 * See: src/features/learning/data/conversations/registry/
 *
        ...
        options: [
          {
            ...
            emoji: '🎉',
            nextNodeId: 'c3a',
            acceptableVariations: ['yes', 'fun', 'it was fun', 'yes it was'],
          },
          {
            text: 'I want to learn more!',
            textTr: 'Daha fazla öğrenmek istiyorum!',
            emoji: '📚',
            nextNodeId: 'c3b',
            acceptableVariations: ['more', 'learn more', 'i want to learn', 'learn'],
          },
        ],
      },
      {
  ...
  buildNodes: (words, translations, emojis) => {
    ...
    return [
      ...
      },
      {
        id: 'n2a',
        speaker: 'nova',
        text: `${e0} You can ${w0} so fast! Amazing!`,
        textTr: `Çok hızlı ${t0.replace('mak', '')}biliyorsun! Harika!`,
        next: 'n3',
      },
      {
        id: 'c1b',
      ...
      },
      {
        id: 'n2b',
        speaker: 'nova',
        text: `${e1} Wow, you can ${w1} so high!`,
        textTr: `Vay, çok yükseğe ${t1.replace('mak', '')}biliyorsun!`,
        next: 'n3',
      },
      {
        id: 'c1c',
      ...
      },
      {
        id: 'n2c',
        speaker: 'nova',
        text: `${e2} Let's ${w2} together! So fun!`,
        textTr: `Birlikte ${t2.replace('mak', '')}yalım! Çok eğlenceli!`,
        next: 'n3',
      },
      {
        id: 'n3',
  ...
  buildNodes: (words, translations, emojis) => {
    ...
    return [
      ...
      },
      {
        id: 'n2a',
        speaker: 'nova',
        text: `${e0} Yes! It is ${w0}! I like ${w0} days!`,
        textTr: `Evet! Hava ${t0}! ${t0} günleri severim!`,
        next: 'n3',
      },
      {
        id: 'c1b',
      ...
      },
      {
        id: 'n2b',
        speaker: 'nova',
        text: `${e1} Oh! It is ${w1}! Do not forget your umbrella!`,
        textTr: `Ay! Hava ${t1}! Şemsiyeni unutma!`,
        next: 'n3',
      },
      {
        id: 'c1c',
      ...
      },
      {
        id: 'n2c',
        speaker: 'nova',
        text: `${e2} Brr! It is ${w2}! Wear a warm jacket!`,
        textTr: `Brr! Hava ${t2}! Sıcak bir ceket giy!`,
        next: 'n3',
      },
      {
        id: 'n3',
  ...
  buildNodes: (words, translations, emojis) => {
    ...
    return [
      ...
      },
      {
        id: 'n2a',
        speaker: 'nova',
        text: `${e0} Your ${w0} is wonderful! I am sure you love your ${w0}!`,
        textTr: `${t0}n harika! Eminim ${t0}nı çok seviyorsun!`,
        next: 'n3',
      },
      {
        id: 'c1b',
      ...
      },
      {
        id: 'n2b',
        speaker: 'nova',
        text: `${e1} That is great! Your ${w1} must be amazing!`,
        textTr: `Harika! ${t1}n muhteşem olmalı!`,
        next: 'n3',
      },
      {
        id: 'c1c',
      ...
      },
      {
        id: 'n2c',
        speaker: 'nova',
        text: `${e2} How nice! Having a ${w2} is wonderful!`,
        textTr: `Ne güzel! ${t2} sahibi olmak harika!`,
        next: 'n3',
      },
      {
        id: 'n3',
...
/**
 * @deprecated Use selectConversationScenario() from conversations/ instead.
