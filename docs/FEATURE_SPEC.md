...
**Kabul Kriterleri:**
- [ ] Parental gate %100 çocuk geçemez (karmaşık işlem)
- [ ] Email validation (format + duplicate check)
- [ ] Şifre min 8 karakter
- [ ] Google/Apple auth otomatik profil oluşturma
...
**Kabul Kriterleri:**
- [ ] İsim boş olamaz, sadece harf ve emoji desteklenir
- [ ] Yaş 4-12 aralığında
- [ ] Avatar seçimi zorunlu
- [ ] Profil Firebase'e kaydedilir
- [ ] Nova yumurtası animasyonu min 3 saniye (dramatik etki)
...
**Kabul Kriterleri:**
- [ ] 3D flip animasyonu 300ms, interruptible
- [ ] Ses otomatik çalmalı (veya AudioContext policy'ye uyum)
- [ ] Tüm kartlar görüldükten sonra aktivite tamamlanır
- [ ] Offline modda cache'den ses çalmalı
...
**Mekanik:**
1. Cümle gösterilir: "The ___ is red."
...
- [ ] İzin reddedilirse: Aktivite "Dinle ve Tekrarla"ya döner (ses kaydı olmadan)
- [ ] Speech recognition offline desteklenmiyorsa: Skip seçeneği
- [ ] Çocuk utanmasın: Asla "Yanlış!" deme, "Tekrar deneyelim!" de
...
**Kabul Kriterleri:**
- [ ] Her sayfa auto-play ses + manual "tekrar dinle"
- [ ] Kelime tıklama pop-up 200ms'de açılır
- [ ] Sayfa geçişi: Kitap çevirme animasyonu
- [ ] Hikaye minimum 6, maximum 12 sayfa
