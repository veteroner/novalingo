...
exports.cleanupExpiredCache = void 0;
const scheduler_1 = require("firebase-functions/v2/scheduler");
const admin_1 = require("../utils/admin");
exports.cleanupExpiredCache = (0, scheduler_1.onSchedule)({
    ...
    const oldWeekNumber = Math.ceil(((fourWeeksAgo.getTime() - startOfYear.getTime()) / 86_400_000 +
        startOfYear.getDay() +
        1) /
        7);
    // Log for tracking
    ...
    const childrenSnap = await admin_1.db.collection('children').select().get();
    for (const childDoc of childrenSnap.docs) {
        const expiredQuests = await admin_1.db
        ...
        const oldSpins = await admin_1.db
