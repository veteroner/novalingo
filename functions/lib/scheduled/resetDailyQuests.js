...
exports.resetDailyQuests = void 0;
...
exports.resetDailyQuests = (0, scheduler_1.onSchedule)({
    ...
    for (const childDoc of childrenSnap.docs) {
        ...
        for (let i = 0; i < selected.length; i++) {
            ...
            const questRef = admin_1.db.doc(`children/${childId}/quests/${today}_${i}`);
            batch.set(questRef, {
                type: template.type,
...
//# sourceMappingURL=resetDailyQuests.js.map