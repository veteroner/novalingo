...
(0, vitest_1.describe)('submitLessonResult', () => {
    ...
    (0, vitest_1.it)('calculates XP correctly for a perfect lesson', async () => {
        ...
        (0, vitest_1.expect)(result.bonusXP).toBe(20 + 7 + 5 + 3);
        (0, vitest_1.expect)(result.xpEarned).toBe(40 + 35);
    ...
    (0, vitest_1.it)('applies streak bonus correctly', async () => {
        ...
        (0, vitest_1.expect)(result.bonusXP).toBe(55);
    ...
    (0, vitest_1.it)('caps streak bonus at 50%', async () => {
        ...
        (0, vitest_1.expect)(result.bonusXP).toBe(55); // 20+7+20+5+3
    });
    ...
    (0, vitest_1.it)('does not give first-try bonus when retries', async () => {
        ...
        (0, vitest_1.expect)(result.bonusXP).toBe(30);
    });
    (0, vitest_1.it)('does not give no-hint bonus when hints used', async () => {
        ...
        (0, vitest_1.expect)(result.bonusXP).toBe(32);
    });
        ...
        (0, vitest_1.expect)(setArgs[0]).toEqual(vitest_1.expect.objectContaining({
            ...
            attempts: [
                vitest_1.expect.objectContaining({
                    ...
                    correct: true,
                    timeSpentMs: 5000,
                    conversationEvidence: vitest_1.expect.objectContaining({ scenarioId: 'greeting-1' }),
                }),
                vitest_1.expect.objectContaining({
                    activityId: 'act-1',
